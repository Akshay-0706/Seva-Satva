...
public class splash extends AppCompatActivity {
    ...
    String version = "", underMaintenance = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference.child("app").child("version").get().addOnCompleteListener(
                task -> {
                    Log.i("result", "onComplete: " + task.getResult().getValue());
                    version = (String) task.getResult().getValue();

                    databaseReference.child("app").child("underMaintenance").get().addOnCompleteListener(
                            task1 -> {
                                Log.i("result", "onComplete: " + task1.getResult().getValue());
                                underMaintenance = (boolean) task1.getResult().getValue() ? "true" : "false";
